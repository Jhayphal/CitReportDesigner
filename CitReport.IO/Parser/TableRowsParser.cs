...
public class TableRowsParser : BlockInstructionParser
{
  protected override CodeContext ActualContext => CodeContext.Block;

  protected override IEnumerable<string> SupportedInstructions { get; } = new string[] { Instructions.Tr };

  public override void Parse(ParserContext context, string current)
  {
    context.Rows = ParseArray(current);
